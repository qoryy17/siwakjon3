...
@section('content')
        ...
        <div class="pc-content">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between py-3">
                    <h3 class="m-0">Detail Rapat Pengawasan</h3>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        @if (Auth::user()->roles != 'User' || Auth::user()->id == $rapat->dibuat)
                            <li class="list-group-item px-0">
                                ...
                                <a class="btn btn-sm btn-primary"
                                    href="{{ route('pengawasan.form-undangan', ['param' => Crypt::encrypt('edit'), 'id' => Crypt::encrypt($rapat->id)]) }}">
                                    <i class="fas fa-pencil-alt"></i> Edit Undangan
                                </a>
                                <a class="btn btn-sm btn-primary"
                                    href="{{ route('pengawasan.form-notula', ['id' => Crypt::encrypt($rapat->id)]) }}">
                        ...
                        <li class="list-group-item px-0">
                            ...
                            <a target="_blank" class="btn btn-sm btn-warning"
                                href="{{ route('pengawasan.print-undangan', ['id' => Crypt::encrypt($rapat->id)]) }}">
                            ...
                            @if ($rapat->detailRapat->notulen != null)
                                <a target="_blank" class="btn btn-sm btn-warning"
                                    href="{{ route('pengawasan.print-notula', ['id' => Crypt::encrypt($rapat->id)]) }}">
                                    <i class="fas fa-file-pdf"></i> Notula
                                </a>
                            @endif
                            @if ($dokumentasi)
                                <a target="_blank" class="btn btn-sm btn-warning"
                                    href="{{ route('pengawasan.print-dokumentasi', ['id' => Crypt::encrypt($rapat->id)]) }}">
    ...
    <form target="_blank" action="{{ route('pengawasan.print-daftar-hadir', ['id' => Crypt::encrypt($rapat->id)]) }}"
        method="GET">
